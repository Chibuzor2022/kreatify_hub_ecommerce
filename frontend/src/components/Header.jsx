...
const Header = () => {
  ...
  const totalCartItems = cartItems.reduce((acc, item) => acc + Number(item.quantity || 0), 0);
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            {user ? (
              <div className="flex items-center gap-3">
                <Link
                  to="/profile"
                  className="hover:text-green-400 max-w-[160px] truncate font-medium"
                  title={user.name}
                >
            ...
            >
              <div className="flex flex-col space-y-3">
                {[
                  ...
                  <motion.div key={item.to} custom={i} initial="hidden" animate="visible" exit="exit" variants={itemVariants}>
                ...
                <motion.div custom={2} initial="hidden" animate="visible" exit="exit" variants={itemVariants}>
                ...
                {/* Auth for Mobile */}
                <motion.div custom={3} initial="hidden" animate="visible" exit="exit" variants={itemVariants}>
                  {user ? (
                    <>
                      <Link to="/profile" className="hover:text-green-400 block">
                        <FaUser className="inline mr-1" />
                        {user.name}
                      </Link>
                      <button onClick={handleLogout} className="text-left hover:text-red-400 block">
                        Logout
                      </button>
                    </>
                  ) : (
                ...
                {user?.isAdmin && (
                  <motion.div custom={4} initial="hidden" animate="visible" exit="exit" variants={itemVariants}>
                    <Link to="/admin/dashboard" className="hover:text-green-400 block">
                      Admin Dashboard
                    </Link>
                  </motion.div>
                )}
